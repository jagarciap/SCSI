...
class System(object):
    def __init__(self):
        ...
        self.at['ts'] = 0
        #TODO: Change later
        self.at['mesh'], self.at['pic'], self.at['e_field'] = mesh_file_reader('2021_03_16.txt')
        self.at['mesh'].print()
...
def HET_E():
    ...
    flux, new_HET_e = system.at['mesh'].children[0].children[0].boundaries[2].createDistributionHET(system.at['part_solver'], system.at['electrons_HET'], in_HET_e_n)
...
def HET_ION():
    ...
    flux, new_HET_ion = system.at['mesh'].children[0].children[0].boundaries[2].createDistributionHET(system.at['part_solver'], system.at['ions_HET'], in_HET_ion_n)
    system.at['mesh'].children[0].children[0].boundaries[2].injectParticlesAtPositions_smooth(flux, system.at['part_solver'],\
                                                               system.at['e_field'], system.at['ions_HET'], new_HET_ion, in_thermal_HET_ion_vel, in_drft_HET_e_vel, system.at['ions_HET'].dt)
