...
class System(object):
    def __init__(self):
        ...
        self.at['ts'] = 0
        #TODO: Change later
        self.at['mesh'], self.at['pic'], self.at['e_field'] = mesh_file_reader('2022_01_20.txt')
        self.at['mesh'].print()
...
system.at['mesh'].boundaries[3].injectParticlesDummyBox(system.at['mesh'].boundaries[3].location, system.at['part_solver'], \
...
def SWE():
    ...
    #        e_n[0]*c.E_V_TH_MP/2/1.7724538509055159*c.E_DT)         #That number is sqrt(pi)
...
def SWP():
    ...
    system.at['mesh'].boundaries[3].injectParticlesDummyBox(system.at['mesh'].boundaries[3].location, system.at['part_solver'], \
                                                            system.at['e_field'], system.at['protons'], p_n[0], thermal_p_vel[0], drift_p_vel[0])
    #flux, n_delta_swp = system.at['mesh'].boundaries[3].createDistributionAtBorder(system.at['mesh'].boundaries[3].location, system.at['part_solver'], system.at['protons'], p_n[0]*c.P_V_SW*c.P_DT)
    #system.at['mesh'].boundaries[3].injectParticlesAtPositions_smooth(flux, system.at['part_solver'], \
