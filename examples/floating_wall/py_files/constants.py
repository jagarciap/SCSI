...
P_DT = 1.329e-8#1.772e-8        # time step for electron dynamics
E_TS = 1    #Timesteps required for execution of electron dynamics
P_TS = 150#300   #Timesteps required for protons dynamics
...
CAPACITY_FILE = "inv_capacity_matrix_2022-01-20_20h08m.txt"
